...
namespace Group.Ecommerce.Infraestructure.Repository
{
    public class CustomersRepository : ICustomersRepository
    {
        ...
        public IEnumerable<Customers> GetAll()
        {
            using (var connection = _connectionFactory.GetConnection)
            {
                var result = connection.Query<Customers>("CustomersList", commandType: CommandType.StoredProcedure);
                return result;
            }
        }
        ...
        public async Task<IEnumerable<Customers>> GetAllAsync()
        {
            using (var connection = _connectionFactory.GetConnection)
            {
                var result = await connection.QueryAsync<Customers>("CustomersList", commandType: CommandType.StoredProcedure);
                return result;
            }
        }
